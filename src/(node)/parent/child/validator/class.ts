...
export class ChildValidator<
  ...
  T_NodeChildAllowedBlueprintAccumulator = never,
> implements _lf {
  /**
  ...
  declare protected readonly _childAllowed: (
    _: T_NodeChildAllowedBlueprintAccumulator
  ) => T_NodeChildAllowedBlueprintAccumulator
  ...
  registerChildAllowed<T_NodeChildBlueprint>(
    ...
    validator:
      ValidatorCb<T_NodeParentBlueprint, T_NodeChildBlueprint> | undefined
  ): ChildValidator<
    T_NodeParentBlueprint,
    T_NodeChildAllowedBlueprintAccumulator | T_NodeChildBlueprint
  > {
  ...
  validate<T_NodeChildBlueprint>({
    ...
    const cb = rawCb as ValidatorCb<T_NodeParentBlueprint, T_NodeChildBlueprint>
