import { isObject } from '../../../object/is/function.js'
 ...
 * unlike in the spec/TypeScript sense checked by `isNonPrimitive`; functions
 * are the two predicates' only disagreement.
 *
 * @remarks
 ...
 *
 * @see {@link ../../nonPrimitive/is/function.js}
 */
